...
*/
	...
	*/
            function parseSizeStr(size) {
                ...
                size = /^([0-9\.]+)([tmgk]?)$/.exec(
                    size.toLowerCase().replace(/[^0-9\.tmkg]/g, "")
                );
                mul = size[2];
                size = +size[1];
            ...
            var UAParser = (function (undefined) {
                ...
                var util = {
                    has: function (str1, str2) {
                        return (
                            str2.toLowerCase().indexOf(str1.toLowerCase()) !==
                            -1
                        );
                    },
            ...
            var can = (function () {
                var caps = {
                    ...
                    use_data_uri_of: function (bytes) {
                        return (
                            (caps.use_data_uri && bytes < 33000) ||
                            caps.use_data_uri_over32kb()
                        );
                    },
            ...
            if (MXI_DEBUG) {
                ...
                Env.log = function () {
                    ...
                    if (window && window.console && window.console.log) {
                        ...
                        if (
                            Basic.inArray(Basic.typeOf(data), [
                                "object",
                                "array",
                            ]) !== -1
                        ) {
            ...
            return {
                RuntimeError: (function () {
                    ...
                    function RuntimeError(code, message) {
                        ...
                        this.message =
                            this.name +
                            (message || ": RuntimeError " + this.code);
                    }
                    ...
                    if (Basic.typeOf(type) !== "string") {
                        ...
                        if (Basic.typeOf(tmpEvt.type) === "string") {
                            ...
                            throw new x.EventException(
                                x.EventException.UNSPECIFIED_EVENT_TYPE_ERR
                            );
                        }
                    }
	...
	*/
		...
		*/
                ...
                if (options.preferred_caps) {
                    defaultMode = Runtime.getMode(
                        modeCaps,
                        options.preferred_caps,
                        defaultMode
                    );
                }
                    ...
                    return {
                        exec: function (uid, comp, fn, args) {
                            if (_shim[comp]) {
                                ...
                                if (objpool[uid].instance[fn]) {
                                    return objpool[uid].instance[fn].apply(
                                        this,
                                        args
                                    );
                                }
                        ...
                        removeAllInstances: function () {
                            ...
                            Basic.each(objpool, function (obj, uid) {
                                if (
                                    Basic.typeOf(obj.instance.destroy) ===
                                    "function"
                                ) {
			...
			*/
                    can: function (cap, value) {
                        ...
                        if (
                            Basic.typeOf(cap) === "string" &&
                            Basic.typeOf(value) === "undefined"
                        ) {
			...
			*/
                    getShimContainer: function () {
                        ...
                        if (!shimContainer) {
                            container =
                                Dom.get(this.options.container) ||
                                document.body;

                            // create shim container and insert it at an absolute position into the outer container
                            shimContainer = document.createElement("div");
                            shimContainer.id = this.shimid;
                            shimContainer.className =
			...
			*/
                    shimExec: function (component, action) {
                        ...
                        return self
                            .getShim()
                            .exec.call(this, this.uid, component, action, args);
                    },
			...
			*/
                ...
                if (
                    this.mode &&
                    options.required_caps &&
                    !this.can(options.required_caps)
                ) {
                    this.mode = false;
                }
            }
                    ...
                    Basic.each(requiredCaps, function (value, cap) {
                        if (modeCaps.hasOwnProperty(cap)) {
                            ...
                            if (!mode) {
                                ...
                                !(mode = Basic.arrayIntersect(mode, capMode))
                            ) {
	...
	*/
                    ...
                    connectRuntime: function (options) {
                        ...
                        function initialize(items) {
                            ...
                            if (!constructor) {
                                if (MXI_DEBUG && Env.debug.runtime) {
                                    Env.log(
                                        "Constructor for '%s' runtime is not available.",
                                        type
                                    );
                                }
                                initialize(items);
                            ...
                            runtime.bind("Error", function () {
                                if (MXI_DEBUG && Env.debug.runtime) {
                                    Env.log(
                                        "Runtime '%s' failed to initialize",
                                        runtime.type
                                    );
                                }
                            ...
                            runtime.bind("Exception", function (e, err) {
                                ...
                                if (MXI_DEBUG && Env.debug.runtime) {
                                    Env.log(
                                        "Runtime '%s' has thrown an exception: %s",
                                        this.type,
                                        message
                                    );
                                }
                        ...
                        initialize(
                            (options.runtime_order || Runtime.order).split(
                                /\s*,\s*/
                            )
                        );
                    },
			...
			*/
                    exec: function () {
                        return runtime
                            ? runtime.exec.apply(this, arguments)
                            : null;
                    },
	...
	*/
			...
			*/
                    isDetached: function () {
                        return (
                            !this.ruid &&
                            Basic.typeOf(blobpool[this.uid]) === "string"
                        );
                    },
	...
	*/
		...
		*/
            ...
            function FileInput(options) {
                ...
                if (
                    Basic.inArray(Basic.typeOf(options), ["string", "node"]) !==
                    -1
                ) {
                ...
                if (typeof options.required_caps === "string") {
                    options.required_caps = Runtime.parseCaps(
                        options.required_caps
                    );
                }
			...
			*/
                    ...
                    setOption: function (name, value) {
                        ...
                        switch (name) {
                            ...
                            case "container":
                            case "required_caps":
                                throw new x.FileException(
                                    x.FileException.NO_MODIFICATION_ALLOWED_ERR
                                );
                        }
	...
	*/
			...
			*/
                    lastModifiedDate:
                        file.lastModifiedDate || new Date().toLocaleString(), // Thu Aug 23 2012 19:40:00 GMT+0400 (GET)
                });
            }
			...
			*/
                ...
                function _read(op, blob) {
                    ...
                    if (this.readyState === FileReader.LOADING) {
                        this.trigger(
                            "error",
                            new x.DOMException(x.DOMException.INVALID_STATE_ERR)
                        );
                        this.trigger("loadend");
                        return;
                    }
                    ...
                    if (!(blob instanceof Blob)) {
                        this.trigger(
                            "error",
                            new x.DOMException(x.DOMException.NOT_FOUND_ERR)
                        );
                        this.trigger("loadend");
                        return;
                    }
	...
	*/
			...
			*/
                    open: function (method, url, async, user, password) {
                        ...
                        if (
                            /[\u0100-\uffff]/.test(method) ||
                            Encode.utf8_encode(method) !== method
                        ) {
                            throw new x.DOMException(x.DOMException.SYNTAX_ERR);
                        }
                        ...
                        if (
                            !!~Basic.inArray(_method, [
                                "CONNECT",
                                "TRACE",
                                "TRACK",
                            ])
                        ) {
                            throw new x.DOMException(
                                x.DOMException.SECURITY_ERR
                            );
                        }
                        ...
                        if ((user || password) && !_same_origin_flag) {
                            throw new x.DOMException(
                                x.DOMException.INVALID_ACCESS_ERR
                            );
                        }
			...
			*/
                    setRequestHeader: function (header, value) {
                        ...
                        if (
                            ...
                            throw new x.DOMException(
                                x.DOMException.INVALID_STATE_ERR
                            );
                        }
                        ...
                        if (
                            /[\u0100-\uffff]/.test(header) ||
                            Encode.utf8_encode(header) !== header
                        ) {
                            throw new x.DOMException(x.DOMException.SYNTAX_ERR);
                        }
				...
				if (/[\u0100-\uffff]/.test(value) || Encode.utf8_encode(value) !== value) {
					throw new x.DOMException(x.DOMException.SYNTAX_ERR);
                        ...
                        if (
                            !!~Basic.inArray(header, uaHeaders) ||
                            /^(proxy\-|sec\-)/.test(header)
                        ) {
                            return false;
                        }
                    ...
                    getResponseHeader: function (header) {
                        ...
                        if (_responseHeaders && _responseHeaders !== "") {
                            ...
                            if (_responseHeadersBag.hasOwnProperty(header)) {
                                return (
                                    _responseHeadersBag[header].header +
                                    ": " +
                                    _responseHeadersBag[header].value
                                );
                            }
                        }
                        return null;
			...
			*/
                    send: function (data, options) {
                        ...
                        // 5
                        _upload_events_flag =
                            !_sync_flag && this.upload.hasEventListener(); // DSAP
                        // 6
                        _error_flag = false;
                        // 7
			...
			*/
                    abort: function () {
                        ...
                        if (
                            ...
                            if (_xhr) {
                                _xhr.getRuntime().exec.call(
                                    _xhr,
                                    "XMLHttpRequest",
                                    "abort",
                                    _upload_complete_flag
                                );
                            } else {
                                throw new x.DOMException(
                                    x.DOMException.INVALID_STATE_ERR
                ...
                function _doXHR(data) {
                    ...
                    function exec(runtime) {
                        ...
                        _xhr.bind("Load", function (e) {
                            ...
                            _responseHeaders = runtime.exec.call(
                                _xhr,
                                "XMLHttpRequest",
                    ...
                    if (typeof _options.required_caps === "string") {
                        _options.required_caps = Runtime.parseCaps(
                            _options.required_caps
                        );
                    }
                ...
                function _run(type, runtime) {
                    ...
                    self.bind(
                        ...
                        function () {
                            ...
                            self.result = _runtime.exec.call(
                                self,
                                "Transporter",
                                "getAsBlob",
                                type || ""
			...
			*/
                    resize: function (options) {
                        ...
                        try {
                            ...
                            if (
                                self.width > Image.MAX_RESIZE_WIDTH ||
                                self.height > Image.MAX_RESIZE_HEIGHT
                            ) {
                                throw new x.ImageError(
                                    x.ImageError.MAX_RESOLUTION_ERR
                                );
                            }
                            ...
                            if (opts.crop) {
                                ...
                                if (options.fit) {
                                    ...
                                    srcRect.width = Math.min(
                                        Math.ceil(opts.width / scale),
                                        self.width
                                    );
                                    srcRect.height = Math.min(
                                        Math.ceil(opts.height / scale),
                                        self.height
                                    );
                                ...
                                switch (
                                    ...
                                    case "right-bottom":
                                        ...
                                        srcRect.y =
                                            self.height - srcRect.height;
                                        break;

                                    case "cb":
                                    case "center-bottom":
                                        srcRect.x = Math.floor(
                                            (self.width - srcRect.width) / 2
                                        );
                                        srcRect.y =
                                            self.height - srcRect.height;
                                        break;
                                    ...
                                    case "right-middle":
                                        srcRect.x = self.width - srcRect.width;
                                        srcRect.y = Math.floor(
                                            (self.height - srcRect.height) / 2
                                        );
                                        break;
			...
			*/
                    embed: function (el, options) {
                        ...
                        try {
                            if (!(el = Dom.get(el))) {
                                throw new x.DOMException(
                                    x.DOMException.INVALID_NODE_TYPE_ERR
                                );
                            }
                            ...
                            if (
                                this.width > Image.MAX_RESIZE_WIDTH ||
                                this.height > Image.MAX_RESIZE_HEIGHT
                            ) {
			...
			*/
                ...
                function _load(src) {
                    ...
                    try {
                        ...
                        // if native blob/file
                            ...
                            Basic.inArray(srcType, ["blob", "file"]) !== -1
                        ) {
                        ...
                        // if source seems to be an img node
                            ...
                            srcType === "node" &&
                            src.nodeName.toLowerCase() === "img"
                        ) {
                            _load.call(this, src.src, arguments[1]);
                        } else {
                            throw new x.DOMException(
                                x.DOMException.TYPE_MISMATCH_ERR
                            );
                        }
                    } catch (ex) {
                        // for now simply trigger error event
                ...
                function _loadFromBlob(blob, options) {
                    ...
                    if (blob.isDetached()) {
                        ...
                        if (
                            options &&
                            typeof options.required_caps === "string"
                        ) {
                            options.required_caps = Runtime.parseCaps(
                                options.required_caps
                            );
                ...
                var caps = Basic.extend(
                    {
                        ...
                        filter_by_extension: Test(
                            (function () {
                                ...
                                return !(
                                    (Env.browser === "Chrome" &&
                                        Env.verComp(Env.version, 28, "<")) ||
                                    (Env.browser === "IE" &&
                                        Env.verComp(Env.version, 10, "<")) ||
                                    (Env.browser === "Safari" &&
                                        Env.verComp(Env.version, 7, "<")) ||
                                    (Env.browser === "Firefox" &&
                                        Env.verComp(Env.version, 37, "<"))
                                );
                            })()
                        ),
                        ...
                        select_folder: function () {
                            return (
                                ...
                                ((Env.browser === "Chrome" &&
                                    ...
                                    (Env.browser === "Firefox" &&
                                        Env.verComp(Env.version, 42, ">="))) // https://developer.mozilla.org/en-US/Firefox/Releases/42
                            );
                        },
                        ...
                        summon_file_dialog: function () {
                            ...
                            return (
                                ...
                                ((Env.browser === "Firefox" &&
                                    ...
                                    (Env.browser === "Opera" &&
                                        Env.verComp(Env.version, 12, ">=")) ||
                                    (Env.browser === "IE" &&
                                        Env.verComp(Env.version, 10, ">=")) ||
                                    !!~Basic.inArray(Env.browser, [
                                        "Chrome",
                                        "Safari",
                                        "Edge",
                                    ]))
        ...
        define("moxie/runtime/html5/file/Blob", [
            ...
            function HTML5Blob() {
                ...
                this.slice = function () {
                    return new Blob(
                        this.getRuntime().uid,
                        w3cBlobSlice.apply(this, arguments)
                    );
                };
            }
                    ...
                    init: function (options) {
                        ...
                        shimContainer.innerHTML =
                            ...
                            (_options.directory
                                ? "uploadFolderForm"
                                : "uploadFileForm") +
                            '" style="font-size:999px;opacity:0;"' +
                            (_options.multiple && I.can("select_multiple")
                                ? "multiple"
                                : "") +
                        ...
                        _browseBtnZIndex =
                            Dom.getStyle(browseButton, "z-index") || "auto";

                        // Route click event to the input[type=file] element for browsers that support such behavior
                        if (I.can("summon_file_dialog")) {
                            if (
                                Dom.getStyle(browseButton, "position") ===
                                "static"
                            ) {
				...
				browse_button loses interactivity, so we restore it here */
                    ...
                    destroy: function () {
                        var I = this.getRuntime(),
                            ...
                            browseButton =
                                _options && Dom.get(_options.browse_button);
                        if (container) {
                ...
                Basic.extend(this, {
                    ...
                    destroy: function () {
                        Events.removeAllEvents(
                            _options && Dom.get(_options.container),
                            this.uid
                        );
            ...
            function XMLHttpRequest() {
                ...
                Basic.extend(this, {
                    send: function (meta, data) {
                        ...
                        if (data instanceof Blob) {
                            ...
                            if (data.hasBlob()) {
                                if (data.getBlob().isDetached()) {
                                    ...
                                    Basic.typeOf(data.getBlob().getSource()) ===
                                        "blob" &&
                                    window.FileReader
                                ) {
                                    ...
                                    case 3: // XMLHttpRequest.LOADING
                                        ...
                                        try {
                                            if (Url.hasSameOrigin(meta.url)) {
                                                ...
                                                total =
                                                    _xhr.getResponseHeader(
                                                        "Content-Length"
                                                    ) || 0; // old Safari throws an exception here
                                            }

                                            if (_xhr.responseText) {
                                                // responseText was introduced in IE7
                                                loaded =
                                                    _xhr.responseText.length;
                                            }
                                        } catch (ex) {
                                            total = loaded = 0;
                                        }
                        ...
                        if (
                            "" !== meta.responseType &&
                            "responseType" in _xhr
                        ) {
                            if (
                                "json" === meta.responseType &&
                        ...
                        try {
                            switch (responseType) {
                                case "blob":
                                    ...
                                    var disposition = _xhr.getResponseHeader(
                                        "Content-Disposition"
                                    );
                                    if (disposition) {
                                ...
                                default:
                                    return _xhr.responseText !== ""
                                        ? _xhr.responseText
                                        : null; // against the specs, but for consistency across the runtimes
                            }
                        } catch (ex) {
                            return null;
                        }
                    ...
                    if (
                        ...
                        return (function () {
                            var progIDs = [
                                "Msxml2.XMLHTTP.6.0",
                                "Microsoft.XMLHTTP",
                            ]; // if 6.0 available, use it, otherwise failback to default 3.0
                    ...
                    fd.each(function (value, name) {
                        ...
                        if (value instanceof Blob) {
                            ...
                            multipart +=
                                ...
                                '"; filename="' +
                                unescape(
                                    encodeURIComponent(value.name || "blob")
                                ) +
                                '"' +
                                crlf +
                                "Content-Type: " +
        ...
        define("moxie/runtime/html5/utils/BinaryReader", [
                            ...
                            case 3:
                                ...
                                if (value instanceof ArrayBuffer) {
                                    var arr = new Uint8Array(
                                        this.length() - size + value.byteLength
                                    );
                                    if (idx > 0) {
                                        arr.set(
                                            new Uint8Array(data.slice(0, idx)),
                                            0
                                        );
                                    }
                                    arr.set(new Uint8Array(value), idx);
                                    arr.set(
                                        new Uint8Array(data.slice(idx + size)),
                                        idx + value.byteLength
                                    );
            ...
            function UTF16StringReader(data) {
                ...
                function putstr(segment, idx, length) {
                    length =
                        arguments.length === 3 ? length : data.length - idx - 1;
                    data =
                        data.substr(0, idx) +
                        segment +
            ...
            function ExifParser(data) {
				...
				*/
                ...
                Basic.extend(this, {
                    read: function () {
                        try {
                            return ExifParser.prototype.read.apply(
                                this,
                                arguments
                            );
                        } catch (ex) {
                            throw new x.ImageError(
                                x.ImageError.INVALID_META_ERR
                            );
                        }
                    },
                    ...
                    write: function () {
                        try {
                            return ExifParser.prototype.write.apply(
                                this,
                                arguments
                            );
                        } catch (ex) {
                    ...
                    EXIF: function () {
                        ...
                        if (offsets.exifIFD) {
                            ...
                            if (
                                Exif.ExifVersion &&
                                Basic.typeOf(Exif.ExifVersion) === "array"
                            ) {
                                for (
                                    var i = 0, exifVersion = "";
                                    i < Exif.ExifVersion.length;
                                    i++
                                ) {
                                    exifVersion += String.fromCharCode(
                                        Exif.ExifVersion[i]
                                    );
                                }
                    ...
                    GPS: function () {
                        ...
                        if (offsets.gpsIFD) {
                            ...
                            if (
                                GPS.GPSVersionID &&
                                Basic.typeOf(GPS.GPSVersionID) === "array"
                            ) {
                        ...
                        if (offsets.IFD1) {
                            try {
                                ...
                                if ("JPEGInterchangeFormat" in IFD1Tags) {
                                    return this.SEGMENT(
                                        offsets.tiffHeader +
                                            IFD1Tags.JPEGInterchangeFormat,
                ...
                if (
                    this.SHORT(0) !== 0xffe1 ||
                    this.STRING(4, 5).toUpperCase() !== "EXIF\0"
                ) {
                ...
                if ("GPSInfoIFDPointer" in Tiff) {
                    offsets.gpsIFD =
                        offsets.tiffHeader + Tiff.GPSInfoIFDPointer;
                ...
                var IFD1Offset = this.LONG(
                    offsets.IFD0 + this.SHORT(offsets.IFD0) * 12 + 2
                );
                if (IFD1Offset) {
                ...
                function extractTags(IFD_offset, tags2extract) {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (type === "ASCII") {
                            hash[tag] = Basic.trim(
                                data.STRING(offset, count).replace(/\0$/, "")
                            ); // strip trailing NULL
                            continue;
                        } else {
	...
	*/
        ...
        define("moxie/runtime/html5/image/ResizerCanvas", [], function () {
            ...
            function _scale(image, ratio) {
                ...
                canvas
                    .getContext("2d")
                    .drawImage(image, 0, 0, sW, sH, 0, 0, dW, dH);
                ...
                Basic.extend(this, {
                    ...
                    getInfo: function () {
                        ...
                        info = {
                            ...
                            size:
                                (_binStr && _binStr.length) || _blob.size || 0,
                            name: _blob.name || "",
                            meta: null,
                        };
	...
	*/
            function FlashRuntime(options) {
                ...
                if (getShimVersion() < 11.3) {
                    if (MXI_DEBUG && Env.debug.runtime) {
                        Env.log(
                            "\tFlash didn't meet minimal version requirement (11.3)."
                        );
                    }
                    ...
                    if (!Basic.isEmptyObj(meta.headers)) {
                        Basic.each(meta.headers, function (value, header) {
                            self.shimExec.call(
                                ...
                                header,
                                value.toString()
                            ); // Silverlight doesn't accept integers into the arguments of type object
                        });
                    }
            ...
            var Image = {
                ...
                getInfo: function () {
                    ...
                    if (
                        info.meta &&
                        info.meta.thumb &&
                        info.meta.thumb.data &&
                        !(self.meta.thumb.data instanceof Blob)
                    ) {
                ...
                try {
                    try {
                        ...
                        if (plugin) {
                            ...
                            do {
                                requiredVersionPart = parseInt(
                                    reqVerArray[index],
                                    10
                                );
                                actualVersionPart = parseInt(
                                    actualVerArray[index],
                                    10
                                );
                                index++;
                            } while (
                                index < reqVerArray.length &&
                            ...
                            initTimer = setTimeout(
                                function () {
                                    if (I && !I.initialized) {
                                        ...
                                        if (MXI_DEBUG && Env.debug.runtime) {
                                            Env.log(
                                                "Silverlight failed to initialize within a specified period of time (5-10s)."
                                            );
                                        }
                                    }
                                },
...
*/
        define("moxie/runtime/silverlight/file/FileReaderSync", [
            ...
            return (extensions.FileReaderSync = Basic.extend(
                {},
                FileReaderSync
            ));
        });
...
*/
        define("moxie/runtime/silverlight/xhr/XMLHttpRequest", [
            ...
            return (extensions.XMLHttpRequest = Basic.extend(
                {},
                XMLHttpRequest
            ));
        });
                    ...
                    init: function (options) {
                        ...
                        (function () {
                            ...
                            if (I.can("summon_file_dialog")) {
                                ...
                                comp.bind("Refresh", function () {
                                    zIndex =
                                        parseInt(_browseBtnZIndex, 10) || 1;
                ...
                Basic.extend(this, {
                    send: function (meta, data) {
                        ...
                        function createIframe() {
                            var container =
                                    I.getShimContainer() || document.body,
                        ...
                        if (data instanceof FormData) {
                            data.each(function (value, name) {
                                if (value instanceof Blob) {
                                    ...
                                    var hidden = document.createElement(
                                        "input"
                                    );
                    ...
                    abort: function () {
                        ...
                        if (_iframe && _iframe.contentWindow) {
                            if (_iframe.contentWindow.stop) {
                                ...
                                _iframe.contentWindow.document.execCommand
                            ) {
                                // IE
                                _iframe.contentWindow.document.execCommand(
                                    "Stop"
