                ...
                >
                    <Toolbar>
                        ...
                        {this.props.selected.length > 1 &&
                            !pathHelper.isMobile() && (
                                <Typography variant="h6" color="inherit" noWrap>
                                    {this.props.selected.length}個對象
                                </Typography>
                            )}
                        {this.props.selected.length <= 1 &&
                            !(
