            ...
            {value === 0 && (
                <DialogContent className={classes.dialogContent}>
                    ...
                    <Typography variant="caption" color={"textSecondary"}>
                        你可以使用<code>*</code>作為萬用字元。比如
                        <code>*.png</code>
                        表示匹配png格式影象。多行規則間會以「或」的關係進行運算。
                    </Typography>
                    <FormLabel className={classes.marginTop}>圖示：</FormLabel>
                    ...
                    <FormLabel className={classes.marginTop}>顏色：</FormLabel>
                    <div className={classes.scroll}>
                        <ToggleButtonGroup
                            size="small"
                            value={color}
