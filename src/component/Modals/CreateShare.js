...
export default function CreatShare(props) {
    ...
    return (
        <Dialog
            ...
            fullWidth
        >
            <DialogTitle id="form-dialog-title">建立分享鏈接</DialogTitle>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <MenuItem value={1}>1 次下載</MenuItem>
                                        <MenuItem value={2}>2 次下載</MenuItem>
                                        <MenuItem value={3}>3 次下載</MenuItem>
                                        <MenuItem value={4}>4 次下載</MenuItem>
                                        <MenuItem value={5}>5 次下載</MenuItem>
                                        <MenuItem value={20}>
                                            20 次下載
                                        </MenuItem>
                                        <MenuItem value={50}>
