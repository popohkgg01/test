            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        <Typography>
                            {siteURL === "" &&
                                "您尚未設定站點URL，是否要將其設定為目前的 " +
                                    window.location.origin +
                                    " ?"}
                            {siteURL !== "" &&
                                "您設定的站點URL與目前實際不一致，是否要將其設定為目前的 " +
                                    window.location.origin +
                                    " ?"}
                        </Typography>
                        <Typography>
                            此設定非常重要，請確保其與您站點的實際地址一致。你可以在
                            參數設定 - 站點資訊 中更改此設定。
                        </Typography>
                    </DialogContentText>
                </DialogContent>
                    ...
                    <div>
                        <List component="nav" aria-label="main mailbox folders">
                            ...
                            >
                                ...
                                <ListItemText primary="Telegram 群組" />
                                <ListItemIcon className={classes.iconRight}>
                                    <Launch />
                                </ListItemIcon>
                            </ListItem>
