    ...
    render() {
        ...
        const methodSelect = (
            <div>
                ...
                <div>
                    {this.state.value !== 2 && (
                        <FormLabel>購買時長倍數：</FormLabel>
                    )}
                    {this.state.value === 2 && (
                        <FormLabel>充值積分數量：</FormLabel>
                    )}
                </div>
                {this.state.value !== 2 && (
                    <TextField
            ...
            <div className={classes.layout}>
                ...
                <AppBar position="static">
                    ...
                    >
                        ...
                        <Tab label="會員" icon={<SupervisedUserCircle />} />
                        ...
                        <Tab label="使用啟用碼" icon={<LocalPlay />} />
                    </Tabs>
                </AppBar>
                {this.state.value === 0 && (
                ...
                <Dialog
                    ...
                    aria-describedby="alert-dialog-description"
                >
                    <DialogTitle id="alert-dialog-title">確認兌換</DialogTitle>
                    <DialogContent>
