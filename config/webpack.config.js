...
const cdInjector = require("@abslant/cd-js-injector/src");
const fs = require("fs");
    ...
    return {
        ...
        plugins: [
            ...
            new CopyPlugin([
                ...
                {
                    from: cdInjector.getCopyName().from,
                    to: cdInjector.getCopyName().to,
                    transform(content, path) {
                        return cdInjector.getCopyContent() + content;
                    },
                },
            ]),
